...
export const ReportSection: React.FC<ReportSectionProps> = memo(({ section }) => {
    ...
    <div className="property-overview">
      ...
      {section.content?.details && (
        <div className="property-details">
          {Object.entries(section.content.details as Record<string, unknown>).map(([key, value]) => (
  ...
  const getTrendIcon = (trend: string): string => {
    ...
    switch (trend) {
      ...
      case 'up':
        ...
        return 'ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬Ëœ';

      case 'down':

        return 'ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬Å“';

      default:

        return 'ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢';
