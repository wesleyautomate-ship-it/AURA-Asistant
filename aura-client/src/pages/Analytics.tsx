      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-md mx-auto">
            Campaign ROI, funnel analysis, request throughput, model usage/cost tracking, and exportable reports coming in v3.0.
          </p>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: 'Campaign ROI', desc: 'Marketing performance' },
            { title: 'Funnel Analysis', desc: 'Conversion tracking' },
            { title: 'Cost Reports', desc: 'AI model usage & billing' },
          ].map((feature, idx) => (
