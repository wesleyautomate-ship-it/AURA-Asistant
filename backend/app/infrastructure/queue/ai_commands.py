...
def execute_ai_command(
    self, command: str, user_id: int, context: Optional[Dict[str, Any]] = None
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        self.update_state(
            state="PROGRESS",
            meta={"current": 0, "total": 100, "status": "Processing AI command..."},
        )
        ...
        self.update_state(
            state="FAILURE",
            meta={"error": str(e), "status": "Command execution failed"},
        )
...
def _generate_cma_report(
    command: str, user_id: int, context: Optional[Dict[str, Any]]
) -> Dict[str, Any]:
