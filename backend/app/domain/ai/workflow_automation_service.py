...
class WorkflowAutomationService:
    ...
    async def create_workflow(
        self, brokerage_id: int, workflow_data: Dict[str, Any], created_by: int
    ) -> WorkflowAutomation:
        ...
        try:
            ...
            brokerage = (
                self.db.query(Brokerage)
                .filter(Brokerage.id == brokerage_id, Brokerage.is_active == True)
                .first()
            )
    ...
    async def get_workflow(
        self, workflow_id: int, brokerage_id: int
    ) -> WorkflowAutomation:
        """Get workflow by ID"""
        try:
            workflow = (
                self.db.query(WorkflowAutomation)
                .filter(
    ...
    async def update_workflow(
        self, workflow_id: int, brokerage_id: int, update_data: Dict[str, Any]
    ) -> WorkflowAutomation:
    ...
    async def list_workflows(
        ...
        try:
            ...
            workflows = (
                query.order_by(WorkflowAutomation.updated_at.desc())
                .offset(skip)
                .limit(limit)
                .all()
            )
    ...
    async def execute_workflow(
        self, workflow_id: int, brokerage_id: int, context: Dict[str, Any] = None
    ) -> Dict[str, Any]:
    ...
    async def _execute_actions(
        self, actions: Dict[str, Any], context: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def _record_workflow_execution(
        self, workflow_id: int, result: Dict[str, Any]
    ):
    ...
    async def get_workflow_analytics(self, brokerage_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            workflows_by_trigger = (
                ...
                .group_by(WorkflowAutomation.trigger_type)
                .all()
            )
            ...
            efficiency_metrics = (
                self.db.query(WorkflowEfficiencyMetric)
                .filter(WorkflowEfficiencyMetric.brokerage_id == brokerage_id)
                .all()
            )
            ...
            if efficiency_metrics:
                avg_efficiency = sum(
                    float(m.efficiency_score or 0) for m in efficiency_metrics
    ...
    async def add_efficiency_metric(
        self, brokerage_id: int, workflow_id: int, efficiency_data: Dict[str, Any]
    ) -> WorkflowEfficiencyMetric:
