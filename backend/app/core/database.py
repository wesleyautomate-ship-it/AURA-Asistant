...
if DATABASE_URL.startswith("sqlite"):
    engine = create_engine(
        ...
        if ":memory:" in DATABASE_URL or DATABASE_URL.startswith("sqlite:///")
        else {},
        echo=False,
    )
else:
...
def init_default_data():
    ...
    try:
        ...
        agent_role = Role(
            name="agent", description="Real estate agents and brokers", is_default=True
        )

        employee_role = Role(name="employee", description="Company staff and employees")

        admin_role = Role(
            name="admin", description="System administrators and managers"
        )
