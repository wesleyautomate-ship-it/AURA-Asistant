                ...
                files.append(
                    {
                        ...
                        "processedDate": row.processed_date.isoformat()
...
async def trigger_daily_briefing(current_user: User = Depends(require_admin)):
    ...
    try:
        ...
        return DailyBriefingResponse(
            message="Daily briefing generation completed successfully"
        )
    except Exception as e:
...
@ingest_router.post(
    "/upload", response_model=DocumentIngestionResponse, tags=["Document Ingestion"]
)
    ...
    try:
        ...
        try:
            ...
            if rag_service and extracted_text:
                ...
                chunks = [
                    extracted_text[i : i + 1000]
                    for i in range(0, len(extracted_text), 1000)
                ]
